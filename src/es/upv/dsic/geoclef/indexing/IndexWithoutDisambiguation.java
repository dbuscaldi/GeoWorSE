...
class IndexWithoutDisambiguation {
  ...
  public static void indexDir(String dir, String lang) 	{
    ...
    try {
	    ...
	    IndexWriter writer = new IndexWriter(FSDirectory.open(new File("nd_index"+lang)), iwc);
  ...
  public static void main(String[] args) throws IOException {
    String usage = "java " + IndexWithoutDisambiguation.class + " <root_directory>";
//    if (args.length == 0) {
  ...
  public static void indexDocs(IndexWriter writer, File file)
    throws IOException {
      ...
      if (file.isDirectory()) {
        ...
        try {
        		MultipleXMLDocumentHandlerSAX hdlr = new MultipleXMLDocumentHandlerSAX(file);
