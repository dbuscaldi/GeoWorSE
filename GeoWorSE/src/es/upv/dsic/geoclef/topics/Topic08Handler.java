 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class Topic08Handler extends DefaultHandler {
	 ...
	 private int mode;
	  ...
	  public Topic08Handler(File xmlFile, AbstractSequenceClassifier classifier, int mode)
...
//	 call at document start
	  ...
	  private Vector<String> getLocations(){
		  ...
		  if(mode>=GeoSearch.TITLE_ONLY) txt+=descBuffer.toString();
		  if(mode==GeoSearch.ALL) txt=txt+" "+narrBuffer.toString();
